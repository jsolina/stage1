...
{
    public class UpdateAddTaskViewModel : INotifyPropertyChanged
    {
        ...
        public UpdateAddTaskViewModel(TaskListDbContext _dbContext, TaskListModel _TaskList, string _updateOrAdd)
        {
